...
namespace Instrument_Communicator_Library.Socket_Clients {
	public class SendingClient : ClientBase{
		public SendingClient(string ip, int port, InstrumentInformation informationAboutClient, AccessToken accessToken, CancellationToken communicatorCancellationToken) : base(ip, port, informationAboutClient, accessToken, communicatorCancellationToken) { }
