...
namespace Server_Library.Server_Listeners.old {
	...
	public class ListenerCrestron : ListenerBase {
		...
		private void serverProtocolAuthorization(CrestronConnection clientConnection) {
			...
			string deviceName = NetworkingOperations.receiveStringWithSocket(connectionSocket);
			string subName = NetworkingOperations.receiveStringWithSocket(connectionSocket);
			...
			clientConnection.setInstrumentInformation(new InstrumentInformation(deviceName,subName, location, type));
		}
